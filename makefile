...
PROJECTS=$(CORE_PROJECT) $(JINJA2_PROJECT) $(HAML_PROJECT) $(SQLALCHEMY_PROJECT) $(ALEMBIC_PROJECT) $(FANSTATIC_PROJECT) $(FORMSKIT_PROJECT) $(FLASHMSG_PROJECT) $(EXAMPLE_PROJECT)
